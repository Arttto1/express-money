    ...
    <div ref={ref}>
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="flex flex-col gap-2 lg:w-[28vw] items-center justify-center bg-customDarkBlue p-4 rounded-lg shadow-md">
          ...
          <h3 className="text-customLightBlue text-xl text-center font-bold">
            SIMULE SEU FINANCIAMENTO VEICULAR
          </h3>
          <div className="lg:text-xl text-center">
            <p>Clique no botão abaixo para acessar a plataforma de simulação <span className="text-2xl text-customBackground">Dryve</span></p>
