      ...
      <section id="contato" className="flex flex-col m-auto mt-20 max-w-[80vw]">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex  flex-col w-fit">
            ...
            <p className="text-xl mb-4 w-fit">
              Se preferir, temos outras formas de contato:
            </p>
            ...
            >
              ...
              <div
                ...
                className="flex items-center w-fit gap-1 border-[2px] px-3 py-1 rounded-full bg-white"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                ...
                <span className="text-xl">17 98169-3120</span>
              </div>
              <div
              ...
              >
                ...
                <span className="text-xl">express.brasil@protonmail.com</span>
              </div>
            </div>
          </div>
        </div>
